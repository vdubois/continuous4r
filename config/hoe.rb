...
DESCRIPTION = "Continuous integration plugin which regroups in one place tests, deployment and analysis tools (rcov, kwala, capistrano...) in a Maven website form."
